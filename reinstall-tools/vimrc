...
let g:vimwiki_list = [{
    \ 'path': '$HOME/Dropbox/wiki_research',
    \ 'template_path': '$HOME/Dropbox/wiki_research/templates',
    \ 'template_default': 'default',
    \ 'template_ext': '.html'},{
    \ 'path': '$HOME/Dropbox/wiki_personal',
    \ 'template_path': '$HOME/Dropbox/wiki_personal/templates',
    \ 'template_default': 'default',
    \ 'template_ext': '.html'},{
...
" Juypytext format: percent
let g:jupytext_fmt = 'py:percent'

" Interpret all tex files as latex
